...
const DEFAULT_CONFIG = {
  ...
  // Per-extension toggles — false = fall back to OpenRouter
  recastLocal:        true,
  recastCheckModel:   "qwen2.5:7b",
  tunnelvisionLocal:  false,
  tunnelvisionModel:  "glm-4.7-flash",
  // Override model for TunnelVision tool calls on OpenRouter (null = use main RP model)
