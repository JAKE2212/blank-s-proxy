...
(function () {
  ...
  function draw(b) {
    ...
    g.addColorStop(0.35, `rgba(210,240,255,${b.alpha * 0.9})`);
    g.addColorStop(0.75, `rgba(150,210,240,${b.alpha * 0.3})`);
    ...
    ctx.beginPath();
    ctx.arc(b.x, b.y, b.r, 0, Math.PI * 2);
    ctx.strokeStyle = `rgba(255,255,255,${b.alpha * 1.7})`;
    ctx.lineWidth = 1.1;
    ctx.stroke();
    ctx.beginPath();
    ctx.ellipse(
    ...
    ctx.fillStyle = `rgba(255,255,255,${b.alpha * 2.4})`;
    ctx.fill();
  }
  ...
  function animate() {
    ...
    bubbles.forEach((b) => {
      b.wobble += b.ws;
      b.y -= b.speed;
      b.x += b.drift + Math.sin(b.wobble) * 0.28;
      draw(b);
    });
